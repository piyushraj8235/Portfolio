    ...
    <div className={styles.page}>
      <div className={styles.container}>
        <header className={styles.header}>
          ...
          <div className={styles.headerContent}>
            ...
            <p className={styles.subtitle}>
              ...
              technologies. Each project demonstrates problem solving,
              development skills, and real-world implementation.
            </p>
          </div>
        </header>
        ...
        <footer className={styles.footer}>
          ...
          <a
            href="https://github.com/piyushraj8235?tab=repositories"
            target="_blank"
